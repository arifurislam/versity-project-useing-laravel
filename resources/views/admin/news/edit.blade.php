        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex justify-content-between mb-3">
                    <h4 class="card-title">Update New News</h4>
                    <a href="{{url('admin/news')}}" class="btn btn-sm btn-danger">
                        <i class="fa-solid fa-arrow-left mr-2"></i>All News
                    </a>
                </div>
                <div class="basic-form">
                    <form method="post" action="{{url('admin/news/'.$news->id.'edit')}}" enctype="multipart/form-data">
                        @csrf
                        @method('put')
                        ...
                        <div class="basic-form">
                            <div class="form-group">
                                <label for="exampleInputEmail1">Details <span class="text-danger">
                                        *</span></label>
                                <textarea name="details" class="my_summerNote form-control h-150">
                                    {{$news->details}}
                                </textarea>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            @endif
                            <img id="imagePreview" src="{{asset('storage/news/'.$news->photo)}}" alt="image preview"
                                class="mt-3 d-block" height="50px">
                        </div>

                        <div class="form-group">
                            <div class="form-check">
                                <input class="form-check-input" name="status" type="checkbox" {{$news->status == 1 ? 'checked':''}}>
