        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex justify-content-between mb-3">
                    <h4 class="card-title">Create Upcoming Event</h4>
                    <a href="{{url('admin/future')}}" class="btn btn-sm btn-danger">
                        <i class="fa-solid fa-arrow-left mr-2"></i>All Upcoming Event
                    </a>
                </div>
                <div class="basic-form">
                    <form method="post" action="{{url('admin/future')}}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="example mb-3">
                            ...
                            <div class="input-group">
                                <input type="date" name="date" class="form-control {{$errors->has('date')? 'has-error':''}}"
