        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex justify-content-between mb-3">
                    <h4 class="card-title">Update New Department</h4>
                ...
                <div class="basic-form">
                    <form method="post" action="{{url('admin/departments/'.$department->id.'edit')}}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            @endif
                            <img id="imagePreview" src="{{asset('storage/department/'.$department->banner)}}" alt="image preview"
                                class="mt-3 d-block" height="50px">
                        </div>

                        <div class="form-group">
                            <div class="form-check">
                                <input class="form-check-input" name="status" type="checkbox" {{$department->status == 1 ? 'checked':''}}>
